...
![Version: 2.30.0](https://img.shields.io/badge/Version-2.30.0-informational?style=flat-square) ![AppVersion: 2.30.0](https://img.shields.io/badge/AppVersion-2.30.0-informational?style=flat-square)
...
* <https://github.com/jaraxasoftware/openvidu-kubernetes>

## Values

| Key | Type | Default | Description |
|-----|------|---------|-------------|
| DeploymentUpdate.deploymentDeadline | int | `180` |  |
| DeploymentUpdate.maxSurge | int | `1` |  |
...
| serviceAccount.tokenAutomount | bool | `false` |  |
...
| services.media-node-controller.image.tag | string | `"2.30.0"` |  |
...
| services.openvidu-call.image.tag | string | `"2.30.0"` |  |
...
| services.openvidu.coturn.iceServers[0] | string | `"turn:localhost:3478,username=turn,credential=nknk"` |  |
...
| services.openvidu.coturn.uris | string | `"turn:localhost:3478"` |  |
...
| services.openvidu.image.tag | string | `"2.30.0"` |  |
...
| services.openvidu.pro.elasticsearch.enabled | bool | `false` |  |
...
| services.openvidu.pro.enabled | bool | `false` |  |
...
| services.openvidu.recording.storage.persistence.accessMode | string | `"ReadWriteOnce"` |  |
| services.openvidu.recording.storage.persistence.annotations | object | `{}` |  |
| services.openvidu.recording.storage.persistence.enabled | bool | `false` |  |
| services.openvidu.recording.storage.s3.accessKey | string | `"ACCESSKEY"` |  |
| services.openvidu.recording.storage.s3.bucket | string | `"jaraxa-openvidu-recordings"` |  |
| services.openvidu.recording.storage.s3.enabled | bool | `false` |  |
| services.openvidu.recording.storage.s3.pathStyle | bool | `false` |  |
| services.openvidu.recording.storage.s3.region | string | `"eu-west-1"` |  |
| services.openvidu.recording.storage.s3.secretKey | string | `"SECRETKEY"` |  |
| services.openvidu.recording.storage.size | string | `"5Gi"` |  |
| services.openvidu.recording.storage.storageClass | string | `"default"` |  |
...
| services.recording.enabled | bool | `false` |  |
| services.recording.image.pullPolicy | string | `"IfNotPresent"` |  |
| services.recording.image.repository | string | `"openvidu/openvidu-recording"` |  |
| services.recording.image.tag | string | `"2.30.0"` |  |
| services.recording.type | string | `"media"` |  |
| stunner.annotations | object | `{}` |  |
| stunner.deployment.container.stunnerd.image.name | string | `"docker.io/l7mp/stunnerd"` |  |
| stunner.deployment.container.stunnerd.image.pullPolicy | string | `"IfNotPresent"` |  |
| stunner.deployment.container.stunnerd.image.tag | string | `"0.21.0"` |  |
| stunner.deployment.container.stunnerd.name | string | `"stunnerd"` |  |
| stunner.enabled | bool | `false` |  |
| stunner.logLevel | string | `"all:INFO"` |  |
| stunner.owncert.enabled | bool | `false` |  |
| stunner.owncert.secret | string | `"tls-secret-p"` |  |
| stunner.password | string | `"jaraxa"` |  |
| stunner.realm | string | `"openvidu"` |  |
| stunner.routesNamespaces | string | `"Same"` |  |
| stunner.username | string | `"turn"` |  |
| stunner.zerossl.dnsNames[0] | string | `"turns.develop.jaraxa.systems"` |  |
| stunner.zerossl.dnsNames[1] | string | `"turn.develop.jaraxa.systems"` |  |
| stunner.zerossl.dnsNames[2] | string | `"stunner.develop.jaraxa.systems"` |  |
| stunner.zerossl.eabKey | string | `"APc9New1vAd4mrGomzUi7w"` |  |
| stunner.zerossl.eabSecret | string | `"0ARcp8LoBXS4BcDcH1F_aq9ZY9EJkypyiwWjfRY-WUZy5MZ2vQ05-IrMbIKYWiO7Uiqs8W_RMf2XPONYZSIy1Q"` |  |
| stunner.zerossl.enabled | bool | `true` |  |
| stunner.zerossl.route53.accessKey | string | `"AKIAJRSPNOF53QMFEPUA"` |  |
| stunner.zerossl.route53.hostedZone | string | `"Z04648343NITAAQ6MU84V"` |  |
| stunner.zerossl.route53.secret | string | `"aws-route53-creds"` |  |
